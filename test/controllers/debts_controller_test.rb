...
class DebtsControllerTest < ActionController::TestCase
  ...
  test "should create debt" do
    assert_difference('Debt.count') do
      post :create, debt: { description: @debt.description, from: @debt.from, quantity: @debt.quantity, to: @debt.to }
    end
  ...
  test "should update debt" do
    patch :update, id: @debt, debt: { description: @debt.description, from: @debt.from, quantity: @debt.quantity, to: @debt.to }
    assert_redirected_to debt_path(assigns(:debt))
  end
